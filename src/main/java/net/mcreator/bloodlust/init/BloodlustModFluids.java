...
import net.mcreator.bloodlust.fluid.BloodFluid;

import java.util.List;
import java.util.ArrayList;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class BloodlustModFluids {
	...
	public static class ClientSideHandler {
		...
		public static void clientSetup(FMLClientSetupEvent event) {
			ItemBlockRenderTypes.setRenderLayer(BLOOD, renderType -> renderType == RenderType.translucent());
			ItemBlockRenderTypes.setRenderLayer(FLOWING_BLOOD, renderType -> renderType == RenderType.translucent());
		}
	}
}
