...
import net.mcreator.bloodlust.world.features.lakes.BloodFeature;
...
public class BloodlustModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(BloodFeature.FEATURE,
				new FeatureRegistration(GenerationStep.Decoration.LAKES, BloodFeature.GENERATE_BIOMES, BloodFeature.CONFIGURED_FEATURE));
	}
